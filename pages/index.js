...
function Img({k,w=18,h=18,style={}}) {
  return <img src={IMG[k]} alt="" style={{width:w,height:h,objectFit:"contain",mixBlendMode:"multiply",...style}}/>;
}
function Dots() {
    ...
    <>
      <Head>
        ...
        <style>{`
          ...
          @font-face { font-family:'NeueKabel'; font-weight:700; font-style:normal; src:url('/fonts/NeueKabel-Bold.otf') format('opentype'); font-display:block; }
          *{box-sizing:border-box;font-family:'NeueKabel',sans-serif;font-weight:400;font-style:normal;}
          ...
          .mi{animation:mi 0.2s ease both} strong{font-weight:700;} button{font-family:'NeueKabel',sans-serif;font-weight:400;}
        `}</style>
      </Head>
