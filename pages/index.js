      ...
      <div style={{ minHeight: "100vh", background: Tk.cream, display: "flex", justifyContent: "center", alignItems: "flex-start", padding: "32px 16px" }}>
        <div
          ...
          <div style={{ flex: 1, overflow: "auto", padding: "30px 28px 16px", display: "flex", flexDirection: "column", gap: 24, position: "relative", minHeight: 420 }}>
            {/* Ambient produce */}
            <div style={{ position: "absolute", left: -34, bottom: 90, width: 130, opacity: 0.10, transform: "rotate(-18deg)", pointerEvents: "none", zIndex: 0 }}><Img k="kale_leaf" w={130} h={130} /></div>
            <div style={{ position: "absolute", right: -28, top: 130, width: 120, opacity: 0.10, transform: "rotate(18deg)", pointerEvents: "none", zIndex: 0 }}><Img k="banana_slice" w={120} h={120} /></div>
            <div style={{ position: "absolute", right: -50, bottom: -30, width: 180, opacity: 0.09, transform: "rotate(-8deg)", pointerEvents: "none", zIndex: 0 }}><Img k="pumpkin" w={180} h={180} /></div>
            <div style={{ position: "absolute", right: -22, top: 180, width: 90, opacity: 0.10, transform: "rotate(14deg)", pointerEvents: "none", zIndex: 0 }}><Img k="avocado" w={90} h={90} /></div>
